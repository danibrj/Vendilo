...
public class HeadManagerMenu {
    ...
    public void show(HeadManagerLogin headManagerLogin, SupportersLogin supportersLogin, HeadManager headManager) {
        ...
        while (isOk1) {
            ...
            switch (choice) {
                ...
                case 2 -> sellerPerfReviewMenu();
                case 3 -> userPerfReviewMenu(users);
                case 4 -> pubCode(users);
                case 5 -> pubMessage(users);
                case 6 -> isOk1 = false;
    ...
    public void pubMessage(List<RegularUser> users) {
    ...
    public void pubCode(List<RegularUser> users) {
    ...
    public void sellerPerfReviewMenu() {
        ...
        while (iscon) {
            ...
            scanner.nextLine();
            switch (select) {
                case 1 -> usualSee(sellers);
                case 2 -> specialSee(sellers);
                case 3 -> iscon = false;
    ...
    public void specialSee(List<Seller> sellers){
    ...
    public void usualSee(List<Seller> sellers) {
        for (int i = 0; i < sellers.size(); i++) {
    ...
    public void vendiloPart(RegularUser user) {
        ...
        scanner.nextLine();
        switchCasePart(today1,someLater,num,user);
    }

    public void switchCasePart(LocalDateTime today1,LocalDateTime someLater,int num,RegularUser user){
        switch (num) {
            case 1 -> {
    ...
    public void putCode2(RegularUser user,KindsOfCode[] items){
        System.out.println("choose one: ");
        int choice2 = scanner.nextInt();
        scanner.nextLine();
        KindsOfCode kindsOfCode = items[choice2 - 1];
